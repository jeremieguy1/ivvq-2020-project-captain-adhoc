    ...
    <div class="hero is-small is-primary">
      <div class="hero-body">
        ...
        <div class="column is-half">
          ...
          <vueper-slides id="slides" class="no-shadow" autoplay arrows-inside bullets-outside transition-speed="250" >
                 ...
                 slides: [
                   {
                     ...
                     image: require('@/assets/ps5.png')
                   },
                   {
                     title: 'El Teide Volcano, Spain',
                     content: 'Photo by Max Rive',
                     // You can also provide a URL for the image'../assets/Tom_Nook.png'.
                     image: require('@/assets/cyberbox.png')
                   }
                 ]
               }),
  methods: {
